...
const taskProfiles = Object.freeze({
  ...
  't4-year11-report-chain': ['reporting', 'Include the separate grade/Life Skills hand-off to the authorised Deputy role without collecting learner-level information.'],
