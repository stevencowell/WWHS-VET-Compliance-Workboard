...
import {KEYS, DATA_KEYS, metadataKey, scopeSnapshot, snapshot} from './team-handover-core.mjs?v=edit-card-text-1';
import {hydrateTeamMetadata} from './team-handover-payloads.mjs?v=edit-card-text-1';
