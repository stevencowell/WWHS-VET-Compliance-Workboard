import {getVetTaskHelp} from './vet-task-help.mjs?v=plain-language-1';
...
const genericNative={
  profileId:'source-task-preparation',label:'Prepare this task',summary:'Prepare a useful draft or checklist for this task.',
  deliverable:'A short plan, source-check table and useful draft or checklist based on the available material.',
  instructions:[
    'Use the task goal and next step below to produce a useful draft, comparison, checklist or plan. Do not just repeat the task as advice.',
    'Start with the information supplied. Name any missing source or fact, and leave that finding unconfirmed.',
    'List any physical work, source checks and authorised decisions a person still needs to carry out.'
  ],
  requiredInputs:['The current authorised sources named for this task, or access to those exact sources.','Any missing facts needed for the requested result.'],
  reviewChecks:['Every claimed requirement or date is supported by an inspected source.','The draft matches this task, period and role.','No checklist completion, official verification or external action is implied by preparing the draft.']
};
const customProfile={
  profileId:'saved-task-guidance',label:'Use the saved help request',summary:'Prepare the result requested in your saved guidance.',
  deliverable:'The result requested in the saved guidance, using the task and sources provided.',
