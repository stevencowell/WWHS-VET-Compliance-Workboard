...
import {INBOX_KEY, LEGACY_PLAN_KEY, validateInbox, validDate, mergeWorkboardImports} from './summary-core.mjs?v=vet-admin-procedures-20260924';
import {CALENDAR_KEY, validateCalendar} from './calendar-core.mjs?v=vet-admin-procedures-20260924';
import {snapshot as teamSnapshot,isTeamItem} from '../../assets/js/team-handover-core.mjs?v=vet-admin-procedures-20260924';
