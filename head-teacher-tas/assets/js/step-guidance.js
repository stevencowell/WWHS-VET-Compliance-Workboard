(function () {
  ...
  const destinations = {
    ...
    guide: ["head-teacher-guide", "Open Head Teacher guide", "Open the named section and check who is responsible and which instructions apply now."],
    ...
    programs: ["program-register", "Open programs and registration folder", "Opens the exact B3 school folder. Select the current approved register or program."],
    assessment: ["assessment-schedules", "Open 2026 assessment schedules", "Opens the named 2026 schedules folder. Confirm the current approved schedule for the course."],
    ...
    whs: ["whs-system", "Open WWHS Work Health and Safety", "Opens the school WHS folder. Choose the current approved procedure and keep confidential records there."],
    maintenance: ["workshop-maintenance", "Open workshop maintenance folder", "Opens the C12 maintenance folder. The task sources above also link the identified maintenance schedule."],
    chemicals: ["chemical-register", "Open chemical register and SDS folder", "Opens the C11 chemical folder, with the 2026 forms and Safety Data Sheets."],
    ...
    vet: ["vet-workboard", "Open VET workboard", "Open the relevant VET task and follow its links to the official systems."],
